package org.sen.modules.shiro.authc;
...
import org.sen.common.util.SpringContextUtils;
...
public class ShiroRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		Set<String> roleSet = sysUserService.getUserRoles(username);
		info.setRoles(roleSet);

		// 设置用户拥有的权限集合，比如“sys:role:add,sys:user:add”
		Set<String> permissionSet = sysUserService.getUserPermission(username);
...
//		 校验token有效性
	...
	public SysUser checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        SysUser loginUser = sysUserService.getSysUserByUsername(username);
		if (loginUser == null) {
